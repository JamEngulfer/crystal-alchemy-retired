...
public class BlockImbuer extends BlockContainer {

    private Icon[] icons = new Icon[3];

    public BlockImbuer(int par1, int par2, Material par3Material) {
    ...
    public boolean onBlockActivated(World world, int x, int y, int z,
        ...
        if (tile_entity == null || player.isSneaking())
            return false;
        player.openGui(CrystalMod.instance, 1, world, x, y, z);
        return true;
    ...
    public void registerIcons(IconRegister iconRegister) {
        icons[0] = iconRegister.registerIcon("CrystalAlchemy:ImbuerBottom");
        icons[1] = iconRegister.registerIcon("CrystalAlchemy:ImbuerTop");
        icons[2] = iconRegister.registerIcon("CrystalAlchemy:ImbuerSide");
    }

    @Override
    public TileEntity createNewTileEntity(World var1) {
        return new ImbuerTileEntity();
    }
}
