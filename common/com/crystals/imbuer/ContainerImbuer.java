...
public class ContainerImbuer extends Container {
    ...
    protected ImbuerTileEntity tile_entity;
    private int lastCookTime = 0;
    private int lastInfuseTime = 0;
    private int lastItemInfuseTime = 0;

    public ContainerImbuer(ImbuerTileEntity tile_entity,
    ...
    public void addCraftingToCrafters(ICrafting par1ICrafting) {
        ...
        par1ICrafting.sendProgressBarUpdate(this, 0, tile_entity.imbueTime);
        par1ICrafting
                .sendProgressBarUpdate(this, 1, tile_entity.imbuerFuelTime);
    ...
    public void detectAndSendChanges() {
        ...
        for (int var1 = 0; var1 < crafters.size(); ++var1) {
            ...
            if (lastCookTime != tile_entity.imbueTime) {
                var2.sendProgressBarUpdate(this, 0, tile_entity.imbueTime);
            }

            if (lastInfuseTime != tile_entity.imbuerFuelTime) {
                var2.sendProgressBarUpdate(this, 1, tile_entity.imbuerFuelTime);
            }
        ...
        lastCookTime = tile_entity.imbueTime;
        lastInfuseTime = tile_entity.imbuerFuelTime;
    ...
    public void updateProgressBar(int par1, int par2) {
        if (par1 == 0) {
            tile_entity.imbueTime = par2;
        }

        if (par1 == 1) {
            tile_entity.imbuerFuelTime = par2;
        }
            ...
            if (par2 == 2) {
                ...
                if (InfuserRecipes.infusing().getInfusingResult(var5) != null) {
                    if (!this.mergeItemStack(var5, 0, 1, false))
                        return null;
                } else if (ImbuerTileEntity.isItemFuel(var5)) {
