...
public class BlockInfuser extends BlockContainer {
    ...
    public BlockInfuser(int par1, int par2, Material par3Material) {
    ...
    public boolean onBlockActivated(World world, int x, int y, int z,
        ...
        if (tile_entity == null || player.isSneaking())
            return false;
        player.openGui(CrystalMod.instance, 0, world, x, y, z);
        return true;
    ...
    public void registerIcons(IconRegister iconRegister) {
        icons[0] = iconRegister.registerIcon("CrystalAlchemy:InfuserBottom");
        icons[1] = iconRegister.registerIcon("CrystalAlchemy:InfuserTop");
        icons[2] = iconRegister.registerIcon("CrystalAlchemy:InfuserSide");
    }
}
