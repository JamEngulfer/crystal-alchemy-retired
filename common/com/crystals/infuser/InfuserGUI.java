...
public class InfuserGUI extends GuiContainer {
    ...
    private InfuserTileEntity infuserInventory;

    public InfuserGUI(InventoryPlayer player_inventory,
            InfuserTileEntity tile_entity) {

        super(new ContainerInfuser(tile_entity, player_inventory));
    ...
    protected void drawGuiContainerForegroundLayer(int i, int j) {
        ...
        fontRenderer.drawString("Alchemical Infuser", 6, 6, 0xffffff);
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2,
            int par3) {
        mc.renderEngine
                .getTexture("/CrystalAlchemy/textures/gui/InfuserGUI.png");
        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
        mc.renderEngine
                .bindTexture("/mods/CrystalAlchemy/textures/gui/InfuserGUI.png");
