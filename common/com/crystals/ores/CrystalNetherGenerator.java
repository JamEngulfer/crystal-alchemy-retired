...
public class CrystalNetherGenerator extends WorldGenerator {
    ...
    public CrystalNetherGenerator(int par1, int par2) {
        minableBlockId = par1;
        numberOfBlocks = par2;
    }

    public CrystalNetherGenerator(int id, int meta, int number) {
        this(id, number);
                        ...
                        if (var39 * var39 + var42 * var42 < 1.0D) {
                            for (int var44 = var34; var44 <= var37; ++var44) {
                                ...
                                Block block = Block.blocksList[par1World
                                        .getBlockId(var38, var41, var44)];
                                if (var39 * var39 + var42 * var42 + var45
                                        * var45 < 1.0D
                                        && block != null
                                        && block == Block.netherrack) {
                                    par1World.setBlockMetadataWithNotify(var38,
                                            var41, var44, minableBlockId,
                                            minableBlockMeta);
                                    // par1World.setBlockAndMetadataWithNotify(var38,
                                    // var41, var44, this.minableBlockId,
                                    // minableBlockMeta);
                                }
                            }
                        }
