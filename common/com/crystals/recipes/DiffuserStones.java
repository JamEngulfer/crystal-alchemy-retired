...
public class DiffuserStones {
    private static final DiffuserStones infusingBase = new DiffuserStones();
     ...
     */
    public static final DiffuserStones infusing() {
        return infusingBase;
    }

    private DiffuserStones() {
